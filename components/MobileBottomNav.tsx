...
const items: NavItem[] = [
  { label: "首页", icon: "home", href: "/", isActive: (p) => p === "/" },
  { label: "收藏", icon: "heart", href: null },
  { label: "对比", icon: "compare", href: null },
  {
    label: "我的",
    icon: "user",
    href: "/login",
 ...
 * the product design. 收藏 / 对比 render as placeholders until those
 * features ship, so no tap dead-ends on a missing route.
 */
    ...
    >
      <div className="pb-safe mx-auto flex max-w-md items-stretch">
        {items.map((item) => {
          ...
          const className = `relative flex min-h-14 flex-1 flex-col items-center justify-center gap-0.5 text-[11px] font-medium transition ${
