...
const FIELD_SEED_NAMES = {
  ...
  composition: ["Composition", "Composition/Theory"],
  ...
  jazz_studies: ["Jazz Studies", "Jazz Studies"],
  ...
  opera_studies: ["Opera Studies", "Voice/Opera"],
  ...
  violin: ["Violin", "Music Performance"],
